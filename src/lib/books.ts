...
export const books: Book[] = [
  ...
  { id: 'l0-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '0', subject: 'رياضيات', coverImageId: 'l0-math', googleDriveLink: 'https://drive.google.com/file/d/1wIQ3sZYGJlKV2UYypIK-ZgQYKY8AWJ_G/preview', content: 'كتاب الرياضيات للمستوى 0' },
  { id: 'l0-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '0', subject: 'لغة عربية', coverImageId: 'l0-arabic', googleDriveLink: 'https://drive.google.com/file/d/11kDqwvAR_FmjRikPypjoKo-h-Yc1E622/preview', content: 'كتاب اللغة العربية للمستوى 0' },
  ...
  { id: 'l1-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '1', subject: 'رياضيات', coverImageId: 'l1-math', googleDriveLink: 'https://drive.google.com/file/d/1TTQYIAm4jpHDk8nc_EGh0goVoihGZRCL/preview', content: 'كتاب الرياضيات للمستوى 1' },
  { id: 'l1-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '1', subject: 'لغة عربية', coverImageId: 'l1-arabic', googleDriveLink: 'https://drive.google.com/file/d/1f0az_IoN59wrdfz-bQ3fYFUr9Wzu0XrK/preview', content: 'كتاب اللغة العربية للمستوى 1' },
  { id: 'l1-math-activity', title: 'أنشطة الرياضيات', author: 'وزارة التربية', gradeLevel: '1', subject: 'أنشطة رياضيات', coverImageId: 'l1-math-activity', googleDriveLink: 'https://drive.google.com/file/d/1zf3as638Lb1P8L4yz4ZCY-iCxKss-UYd/preview', content: 'كتاب أنشطة الرياضيات للمستوى 1' },
  { id: 'l1-arabic-activity', title: 'أنشطة اللغة العربية', author: 'وزارة التربية', gradeLevel: '1', subject: 'أنشطة لغة عربية', coverImageId: 'l1-arabic-activity', googleDriveLink: 'https://drive.google.com/file/d/1drfdNuW5RNaWhdrxUl3wYUD1H452-J2b/preview', content: 'كتاب أنشطة اللغة العربية للمستوى 1' },
  ...
  { id: 'l2-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '2', subject: 'رياضيات', coverImageId: 'l2-math', googleDriveLink: 'https://drive.google.com/file/d/1Qw2HQa5-n2o9_cHNf-JaNSp2gx5_OLcX/preview', content: 'كتاب الرياضيات للمستوى 2' },
  { id: 'l2-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '2', subject: 'لغة عربية', coverImageId: 'l2-arabic', googleDriveLink: 'https://drive.google.com/file/d/1oYceUUGNtUAO0C-XnkIHMTZ5kknPA_5J/preview', content: 'كتاب اللغة العربية للمستوى 2' },
  { id: 'l2-math-activity', title: 'أنشطة الرياضيات', author: 'وزارة التربية', gradeLevel: '2', subject: 'أنشطة رياضيات', coverImageId: 'l2-math-activity', googleDriveLink: 'https://drive.google.com/file/d/1MjT8OUa6NmesJ76dudTjk-lFisz_VRif/preview', content: 'كتاب أنشطة الرياضيات للمستوى 2' },
  { id: 'l2-arabic-activity', title: 'أنشطة اللغة العربية', author: 'وزارة التربية', gradeLevel: '2', subject: 'أنشطة لغة عربية', coverImageId: 'l2-arabic-activity', googleDriveLink: 'https://drive.google.com/file/d/1C7SNCzSqkZK01cmwPdy3reeiuMtOxyuR/preview', content: 'كتاب أنشطة اللغة العربية للمستوى 2' },
  ...
  { id: 'l3-civics', title: 'كتاب التربية المدنية', author: 'وزارة التربية', gradeLevel: '3', subject: 'تربية مدنية', coverImageId: 'l3-civics', googleDriveLink: 'https://drive.google.com/file/d/1cMkI0t_K9dY0JOuBgo5SkUVTcTLyGoj2/preview', content: 'كتاب التربية المدنية للمستوى 3' },
  { id: 'l3-english', title: 'كتاب الإنجليزية', author: 'وزارة التربية', gradeLevel: '3', subject: 'إنجليزية', coverImageId: 'l3-english', googleDriveLink: 'https://drive.google.com/file/d/1_DgP2RP4SL0S3CoTNn7zNbWkwmn6x2dz/preview', content: 'كتاب الإنجليزية للمستوى 3' },
  { id: 'l3-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '3', subject: 'رياضيات', coverImageId: 'l3-math', googleDriveLink: 'https://drive.google.com/file/d/1t1LAUB7dTppxBAoUOSd2DmOtGp09Juus/preview', content: 'كتاب الرياضيات للمستوى 3' },
  { id: 'l3-hist-geo', title: 'كتاب التاريخ والجغرافيا', author: 'وزارة التربية', gradeLevel: '3', subject: 'تاريخ وجغرافيا', coverImageId: 'l3-hist-geo', googleDriveLink: 'https://drive.google.com/file/d/1g8mjIRS7RQ7vGgNKc33CiPwmrXGZtmzU/preview', content: 'كتاب التاريخ والجغرافيا للمستوى 3' },
  { id: 'l3-islamic', title: 'كتاب التربية الإسلامية', author: 'وزارة التربية', gradeLevel: '3', subject: 'تربية إسلامية', coverImageId: 'l3-islamic', googleDriveLink: 'https://drive.google.com/file/d/1s8cjQYOtunVcnZ7gsUum5_QkG0L5wv2_/preview', content: 'كتاب التربية الإسلامية للمستوى 3' },
  { id: 'l3-science', title: 'كتاب التربية العلمية', author: 'وزارة التربية', gradeLevel: '3', subject: 'تربية علمية', coverImageId: 'l3-science', googleDriveLink: 'https://drive.google.com/file/d/1IZ9c40P50b9ylh_6OxIM0hcpJyjAeL/preview', content: 'كتاب التربية العلمية للمستوى 3' },
  { id: 'l3-french', title: 'كتاب اللغة الفرنسية', author: 'وزارة التربية', gradeLevel: '3', subject: 'لغة فرنسية', coverImageId: 'l3-french', googleDriveLink: 'https://drive.google.com/file/d/H74R0nnRD3p5HI07oWwTfbDJrRj/preview', content: 'كتاب اللغة الفرنسية للمستوى 3' },
  { id: 'l3-math-activity', title: 'أنشطة الرياضيات', author: 'وزارة التربية', gradeLevel: '3', subject: 'أنشطة رياضيات', coverImageId: 'l3-math-activity', googleDriveLink: 'https://drive.google.com/file/d/1wy2HQ0YLB0-sBffAiuCwmGpgNeO8kUXC/preview', content: 'كتاب أنشطة الرياضيات للمستوى 3' },
  { id: 'l3-french-activity', title: 'أنشطة الفرنسية', author: 'وزارة التربية', gradeLevel: '3', subject: 'أنشطة فرنسية', coverImageId: 'l3-french-activity', googleDriveLink: 'https://drive.google.com/file/d/1qzIuD3LleIntoamVc7yE1oDRNfjZngU0/preview', content: 'كتاب أنشطة الفرنسية للمستوى 3' },
  { id: 'l3-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '3', subject: 'لغة عربية', coverImageId: 'l3-arabic', googleDriveLink: 'https://drive.google.com/file/d/1J3Ek2uXrKdIZf6N6p0uxLtJado42ujmj/preview', content: 'كتاب اللغة العربية للمستوى 3' },
  { id: 'l3-arabic-activity', title: 'أنشطة اللغة العربية', author: 'وزارة التربية', gradeLevel: '3', subject: 'أنشطة لغة عربية', coverImageId: 'l3-arabic-activity', googleDriveLink: 'https://drive.google.com/file/d/1hTuRgqcH5Ulwv2SWJ93SCa-NtU8__UWu/preview', content: 'كتاب أنشطة اللغة العربية للمستوى 3' },
  ...
  { id: 'l4-amazigh', title: 'كتاب الأمازيغية', author: 'وزارة التربية', gradeLevel: '4', subject: 'أمازيغية', coverImageId: 'l4-amazigh', googleDriveLink: 'https://drive.google.com/file/d/1JxNzyk-qGRUJpU2Ip91pk4IEBj6tRpiD/preview', content: 'كتاب الأمازيغية للمستوى 4' },
  { id: 'l4-hist-geo', title: 'كتاب التاريخ والجغرافيا', author: 'وزارة التربية', gradeLevel: '4', subject: 'تاريخ وجغرافيا', coverImageId: 'l4-hist-geo', googleDriveLink: 'https://drive.google.com/file/d/1AJFeqSVXYXg_uUv0Fate9VPjP6CFOA3V/preview', content: 'كتاب التاريخ والجغرافيا للمستوى 4' },
  { id: 'l4-islamic', title: 'كتاب التربية الإسلامية', author: 'وزارة التربية', gradeLevel: '4', subject: 'تربية إسلامية', coverImageId: 'l4-islamic', googleDriveLink: 'https://drive.google.com/file/d/1gUfxW2tLu9uLCEjrpCGRSBRqQntOSB3C/preview', content: 'كتاب التربية الإسلامية للمستوى 4' },
  { id: 'l4-science', title: 'كتاب التربية العلمية', author: 'وزارة التربية', gradeLevel: '4', subject: 'تربية علمية', coverImageId: 'l4-science', googleDriveLink: 'https://drive.google.com/file/d/1LWqDkMVFS6UDm7Pz7xaDTri0iEGeqdlc/preview', content: 'كتاب التربية العلمية للمستوى 4' },
  { id: 'l4-civics', title: 'كتاب التربية المدنية', author: 'وزارة التربية', gradeLevel: '4', subject: 'تربية مدنية', coverImageId: 'l4-civics', googleDriveLink: 'https://drive.google.com/file/d/1LfJ0EmS8BHXo1SptmIV-wVMpJU9Gy9yD/preview', content: 'كتاب التربية المدنية للمستوى 4' },
  { id: 'l4-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '4', subject: 'رياضيات', coverImageId: 'l4-math', googleDriveLink: 'https://drive.google.com/file/d/1OMFaaxsD6_qPffMo4J9ewUcONGb2LjFI/preview', content: 'كتاب الرياضيات للمستوى 4' },
  { id: 'l4-english', title: 'كتاب الإنجليزية', author: 'وزارة التربية', gradeLevel: '4', subject: 'إنجليزية', coverImageId: 'l4-english', googleDriveLink: 'https://drive.google.com/file/d/1tSBmV97GTNL73tgkx45W_VbnDq-_RhPd/preview', content: 'كتاب الإنجليزية للمستوى 4' },
  { id: 'l4-french', title: 'كتاب اللغة الفرنسية', author: 'وزارة التربية', gradeLevel: '4', subject: 'لغة فرنسية', coverImageId: 'l4-french', googleDriveLink: 'https://drive.google.com/file/d/1VdNtnHu5Itzg63WmNjO1fkM60xeSom75/preview', content: 'كتاب اللغة الفرنسية للمستوى 4' },
  { id: 'l4-math-activity', title: 'أنشطة الرياضيات', author: 'وزارة التربية', gradeLevel: '4', subject: 'أنشطة رياضيات', coverImageId: 'l4-math-activity', googleDriveLink: 'https://drive.google.com/file/d/1s727Nz-6m9vNWFN4NiP15ztdROSotJMK/preview', content: 'كتاب أنشطة الرياضيات للمستوى 4' },
  { id: 'l4-arabic-activity', title: 'أنشطة اللغة العربية', author: 'وزارة التربية', gradeLevel: '4', subject: 'أنشطة لغة عربية', coverImageId: 'l4-arabic-activity', googleDriveLink: 'https://drive.google.com/file/d/1byOAfbdD-Y8tAQcFMyWSH7hwO1LUN7W1/preview', content: 'كتاب أنشطة اللغة العربية للمستوى 4' },
  { id: 'l4-french-activity', title: 'أنشطة الفرنسية', author: 'وزارة التربية', gradeLevel: '4', subject: 'أنشطة فرنسية', coverImageId: 'l4-french-activity', googleDriveLink: 'https://drive.google.com/file/d/1d5ofJIc7vRcRn733bvalGAuXlNnXmwie/preview', content: 'كتاب أنشطة الفرنسية للمستوى 4' },
  { id: 'l4-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '4', subject: 'لغة عربية', coverImageId: 'l4-arabic', googleDriveLink: 'https://drive.google.com/file/d/1QLu2nILaE2p5JBp93D3Lwc7YiZpAAB6S/preview', content: 'كتاب اللغة العربية للمستوى 4' },
  ...
  { id: 'l5-civics', title: 'كتاب التربية المدنية', author: 'وزارة التربية', gradeLevel: '5', subject: 'تربية مدنية', coverImageId: 'l5-civics', googleDriveLink: 'https://drive.google.com/file/d/1dMqQtqsXEfhVk7QvbdX8ajv99aBd4-Gm/preview', content: 'كتاب التربية المدنية للمستوى 5' },
  { id: 'l5-math', title: 'كتاب الرياضيات', author: 'وزارة التربية', gradeLevel: '5', subject: 'رياضيات', coverImageId: 'l5-math', googleDriveLink: 'https://drive.google.com/file/d/1cZ8-0T4M61HAfySXSt2rrHu7gZ1XTOjG/preview', content: 'كتاب الرياضيات للمستوى 5' },
  { id: 'l5-amazigh', title: 'كتاب الأمازيغية', author: 'وزارة التربية', gradeLevel: '5', subject: 'أمازيغية', coverImageId: 'l5-amazigh', googleDriveLink: 'https://drive.google.com/file/d/1mk0DHPSsjfZdyS-BL7Lv9hDV9ifCERPQ/preview', content: 'كتاب الأمازيغية للمستوى 5' },
  { id: 'l5-history', title: 'كتاب التاريخ', author: 'وزارة التربية', gradeLevel: '5', subject: 'تاريخ', coverImageId: 'l5-history', googleDriveLink: 'https://drive.google.com/file/d/1pKJVckskdvdXg-mtynYXYlblIc6oLZsu/preview', content: 'كتاب التاريخ للمستوى 5' },
  { id: 'l5-islamic', title: 'كتاب التربية الإسلامية', author: 'وزارة التربية', gradeLevel: '5', subject: 'تربية إسلامية', coverImageId: 'l5-islamic', googleDriveLink: 'https://drive.google.com/file/d/1BufqoMm7Kq6Fy_7ksl4g_BDxx714n42D/preview', content: 'كتاب التربية الإسلامية للمستوى 5' },
  { id: 'l5-science', title: 'كتاب التربية العلمية', author: 'وزارة التربية', gradeLevel: '5', subject: 'تربية علمية', coverImageId: 'l5-science', googleDriveLink: 'https://drive.google.com/file/d/1Trs0LWN7ejOW1IhWf9CCtkCgUPVmJsHe/preview', content: 'كتاب التربية العلمية للمستوى 5' },
  { id: 'l5-geography', title: 'كتاب الجغرافيا', author: 'وزارة التربية', gradeLevel: '5', subject: 'جغرافيا', coverImageId: 'l5-geography', googleDriveLink: 'https://drive.google.com/file/d/18CmhHXxs-4rxM5CNhHgPIwGXi90SXrFM/preview', content: 'كتاب الجغرافيا للمستوى 5' },
  { id: 'l5-french', title: 'كتاب اللغة الفرنسية', author: 'وزارة التربية', gradeLevel: '5', subject: 'لغة فرنسية', coverImageId: 'l5-french', googleDriveLink: 'https://drive.google.com/file/d/1TerUQ4xr1AKfEriRpV353sa1nr1hpJ09/preview', content: 'كتاب اللغة الفرنسية للمستوى 5' },
  { id: 'l5-math-activity', title: 'أنشطة الرياضيات', author: 'وزارة التربية', gradeLevel: '5', subject: 'أنشطة رياضيات', coverImageId: 'l5-math-activity', googleDriveLink: 'https://drive.google.com/file/d/1e4s_Sjy1B8SMPt_QWXOLlJnn8gV5u60L/preview', content: 'كتاب أنشطة الرياضيات للمستوى 5' },
  { id: 'l5-french-activity', title: 'أنشطة الفرنسية', author: 'وزارة التربية', gradeLevel: '5', subject: 'أنشطة فرنسية', coverImageId: 'l5-french-activity', googleDriveLink: 'https://drive.google.com/file/d/1-lZqrXXkxyGYu18LuLUNe0aD5otmjlWV/preview', content: 'كتاب أنشطة الفرنسية للمستوى 5' },
  { id: 'l5-arabic', title: 'كتاب اللغة العربية', author: 'وزارة التربية', gradeLevel: '5', subject: 'لغة عربية', coverImageId: 'l5-arabic', googleDriveLink: 'https://drive.google.com/file/d/1Bd-VKcxRaULWEYHb-Y5__pdpsu0cn2f9/preview', content: 'كتاب اللغة العربية للمستوى 5' },
];

export const gradeLevels = ['0', '1', '2', '3', '4', '5'];
@@ -84,3 +85,5 @@ export const subjects: Array<Book['subject']> = [
  'تاريخ',
  'جغرافيا'
];
